 ...
 * @author mwilbers
 *
 *         FIXME: ApplicationFActory can be completely removed and is replaced
 *         by AppConfigService
 *
 */
public class DefaultApplicationFactory implements ApplicationFactory {
	...
	public void init() {
		...
		//
		// String userAreaName =
		// this.applicationConfigService.getPropertyValue(ApplicationConfigService.KEY_USERAREA);
		// List<AnsichtDef> viewList =
		// this.ofdbService.loadViewsForRegistration(userAreaName);
		//
		// if (null == viewList) {
		// return;
		// }
		...
		// this.viewConfigFactory.createViewConfiguration(ansichtDef.getName());
