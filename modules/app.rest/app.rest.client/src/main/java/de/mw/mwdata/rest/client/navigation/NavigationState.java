...
/**
 * A NavigationState hold all state information for the current user navigation position like the url, 
 * the sorting and filtering informations or paging information.
 * @author mwilbers
 *
 */
public interface NavigationState extends Serializable {
	...
	/**
	 * Returns the {@link EntityTO}-object simulating the filter-state of all filterfields from the current view
	 * 
	 * @return
	 */
