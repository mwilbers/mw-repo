...
public class ViewConfiguration {
	...
	/*
	 * FIXME: Umbau geplant: a) viewColumns hier sollte Map<AnsichtDef,AnsichtSpalten> sein. Analog für andere Maps ...
	 * => also equals , hashCode methode in AnsichtDef erstellen b) ViewConfigHandle sollte keine add-methoden mehr
	 * haben, stattdessen nur noch schlaues ReadOnly machen c) add-Methoden in eine innere Klasse
	 * ViewConfiguration.Builder verschieben.
	 *
	...
	/** contains all underlying tables defined in viewTab. Same tables can be duplicated in more viewConfigs */
	private List<ITabDef>				tableDefs	= new ArrayList<ITabDef>();

	/** contains the list of tableProperties for every involved table to this viewConfiguration */
