...
/**
 * Abstract class for managing fx-wide domain-objects. An fx-specific object has
 * to implement the db-fields
 *
 * <pre>
 * <b><blockquote>
 ...
 * </pre>
 *
 * The Ids are managed with a db-specific sequence. The key of the sequence has
 * to be implemented by the implementing class.<br>
 * FIXME: There should be an abstract base class in ofdb-api for defining
 * getId() and getName() and implementing <br>
 * hashCode() and equals() because ofdb-api says "our entities are defined by
 * unique natural key"
 *
...
public abstract class AbstractMWEntity implements Serializable, IEntity {
	...
	/**
	 * FIXME: do not use java.util.Date because of problems in comparing with
	 * java.sql.Timestamp.
	 *
