...
/**
 * This class is only needed for tests and contains all java-constants for
 * tables, db-columns and other objects which are referenced in the unit-tests.
 *
...
public class TestConstants {
	...
	public static final String TABLENAME_MENU = "FX_Menues_K";
