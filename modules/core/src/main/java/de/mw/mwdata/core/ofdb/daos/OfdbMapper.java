...
public class OfdbMapper extends HibernateDaoSupport {
	...
	/**
	 * Method is called when instantiating the spring-defined DAO-Beans in appContext-ofdb.xml
	 */
	...
	/**
	 * Method builds a map in memory with key = columnName from DB and value = index of property in
	 * hibernate-persister-class for optimizing performance.<br>
