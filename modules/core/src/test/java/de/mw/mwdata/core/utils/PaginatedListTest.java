...
public class PaginatedListTest {
	...
	//
	// log.debug( "Paging testInitListWith30ItemAndCount137AndIndex1: " +
	// list.toString() );
	// Assert.assertEquals( "Wrong number of paginated list-items", 137,
	// list.getCount() );
	...
	// Assert.assertEquals( "Wrong number of greater steps",
	// PaginatedList.DEFAULT_NUMSTEPS / 2,
	// list.getStepsGreater() );
	// Assert.assertEquals( "Wrong number of smaller steps", 4,
	// list.getStepsSmaller() );
	//
	// }
