...
public class AbstractCrudService<T> implements ICrudService<T>, ICrudInterceptable {
	...
	/**
	 * unordered list of additional interceptors. Can be used for registering further interceptors from consumer
	 * applications
	 */
	...
	public T insert( final T entity ) {
		...
		try {
			// FIXME: if needed: if ( this.applicationFactory.getState().equals( ApplicationState.RUNNING ) ) {
			// FIXME: do equalize arguments IFxPersistable and AbstractMWEntity here and in update method
	...
	public void delete( final T entity ) {
		...
		// this.crudInterceptorChain.doChainActionsBeforeCheck( (AbstractMWEntity) entity );
