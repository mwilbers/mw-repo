...
public class TabDef extends AbstractMWEntity implements ITabDef {
	...
	// ... klären,wie equals und hashcode implementiert werden sollten ... -> buch effective java
	// Lösungen für Unittest:
	// 1. könnte sein, dass das TestNG-Problem mit doppelter AnsichtDef daher kommt, dass die gleiche ansicht zwei mal
